...
- Beat Sequencer (extra-feature)

![picture](/wireframe/BeatSequencer.png)
...
- Sample.js: Functional. Will display the sample name, instrument, type, genre, and bpm, and a download button. Also a download function.
